...
export default function NewContentPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      switch (contentType) {
        case "text":
          specificResponse = await fetch(`/api/admin/lessons/contents/text`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
        ...
        case "video":
          specificResponse = await fetch(`/api/admin/lessons/contents/video`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
        ...
        case "activity":
          specificResponse = await fetch(`/api/admin/lessons/contents/activity`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
        ...
        case "reunion":
          ...
          specificResponse = await fetch(`/api/admin/lessons/contents/reunion`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
      ...
      if (!specificResponse || !specificResponse.ok) {
        throw new Error(`Falha ao salvar detalhes do ${getContentTypeLabel(contentType).toLowerCase()}`);
      }
      
      setAlert({
        type: "success",
        message: `${getContentTypeLabel(contentType)} criado com sucesso!`,
      });
      ...
      setAlert({
        type: "error",
        message: err.message || `Erro ao criar ${getContentTypeLabel(contentType).toLowerCase()}`,
      });
    } finally {
      setSaving(false);
    }
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold">
            Novo {getContentTypeLabel(contentType)}
          </h1>
      ...
      <div className="space-y-6">
        ...
        <div className="form-control mt-8">
          <button
            type="button" // Alterado de "submit" para "button" para evitar envio automático
            className={`btn btn-primary ${saving ? "loading" : ""}`}
            disabled={saving}
            onClick={handleSubmit} // Adicionado o onClick diretamente
          >
