...
export default function EditVideoContentPage() {
  ...
  const [content, setContent] = useState<VideoContentDetail | null>(null);
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // Buscar detalhes do conteúdo de vídeo
        const contentResponse = await fetch(`/api/admin/lessons/contents/content/${contentId}?type=video`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/lessons/contents/video/${contentId}`, {
        method: "PUT",
        headers: {
      ...
      setAlert({
        type: "error",
        message: err.message || "Erro ao atualizar vídeo",
      });
